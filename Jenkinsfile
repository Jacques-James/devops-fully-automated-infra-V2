    ...
    stages {
        stage('Git checkout') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/Jacques-James/devops-fully-automated-infra-V2.git'
                sh 'ls'
            }
        }
     ...
     post { 
        always { 
            ...
            slackSend channel: '#teamawsers2022', color: COLOR_MAP[currentBuild.currentResult], message: "*${currentBuild.currentResult}:* Job ${env.JOB_NAME} build ${env.BUILD_NUMBER} \n More info at: ${env.BUILD_URL}"
        }
    }
